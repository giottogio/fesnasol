	...
	<div class="container">
		...
		<aside>
			...
			<div class="sidebar">
                ...
                <a href="ajustes.php" class="active">
		...
		<main>
			...
			<div class="recent_order">
                ...
                <!--NAV TABS-->
                   ...
                   <!-- NAV TABS -->
                    <nav class="nav-tabs">
                        <label for="home" class="home"> Festivales </label>
                        <label for="blog" class="blog"> participantes   </label>
                        <label for="code" class="code"> grupos </label>
                        <label for="help" class="help"> staff </label>
                    ...
                    <section class="nav-tab-container">
                        <div class="content content-1">
                            <div class="title">Festivales registrados</div>
            ...
            <tr>
                ...
                <th>Salary</th>
                        ...
                        <div class="content content-2">
                            <div class="title">participantes de festival</div>
            ...
            <tr>
                ...
                <th>Salary</th>
                        ...
                        <div class="content content-3">
                            <div class="title">Grupos que participan en festivales</div>
